...
namespace Server
{
    public class Tracker : BaseScript
    {
        ...
        private Dictionary<string, GpsDic>      gpsListing    { get; set; }
        ...
        {
            var linq    = gpsListing.FirstOrDefault(x => x.Value.PedLicence == player.Identifiers["license"]);
        ...
        private class GpsNetworkClient
        {
            public string  PedId;
