...
//    using QbBridge;
//
//    var welcome6 = QbCore.FromJson(jsonString);
...
namespace QbBridge
{
    ...
    public partial class QbCore
    {
        public static QbCore FromJson(string json) => JsonConvert.DeserializeObject<QbCore>(json, QbBridge.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this QbCore self) => JsonConvert.SerializeObject(self, QbBridge.Converter.Settings);
    }
